...
import com.bank.transaction_service.infrastructure.rest.interceptor.AuthTokenInterceptor;
import com.bank.transaction_service.infrastructure.security.SecurityReactiveUserDetailsService;
...
public class SecurityConfig {
  ...
  public SecurityWebFilterChain springSecurityFilterChain(
    ...
    http.csrf(ServerHttpSecurity.CsrfSpec::disable)
        ...
        .addFilterBefore(
            new AuthTokenInterceptor(this.authGrpcClientService),
