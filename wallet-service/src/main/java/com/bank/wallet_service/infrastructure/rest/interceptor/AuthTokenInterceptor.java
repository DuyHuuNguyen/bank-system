package com.bank.wallet_service.infrastructure.rest.interceptor;

import com.bank.wallet_service.api.response.UnAuthenticationResponse;
...
public class AuthTokenInterceptor implements WebFilter {
  ...
  private final List<String> PUBLIC_APIS =
      List.of("/actuator/", "/api/v1/wallets/internal/transfer");
